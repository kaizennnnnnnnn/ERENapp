...
import {
  PURPLE, PURPLE_HI, PURPLE_LO,
  OBSIDIAN_FACE, OBSIDIAN_BTN, OBSIDIAN_ORB,
  Rivets, ObsidianChip, purpleText,
  ...
  if (loading) {
    return (
      <div className="page-scroll flex items-center justify-center min-h-[60vh]" style={pageStyle}>
        <span className="font-pixel animate-pulse-soft" style={{ fontSize: 8, color: PURPLE_HI, textShadow: `0 0 4px ${PURPLE}66` }}>
    ...
    <div className="page-scroll" style={pageStyle}>
      ...
      <div className="flex items-center gap-2 mb-2">
        <button onClick={() => { playSound('ui_back'); router.back() }}
          ...
          <Rivets inset={2} />
          <ChevronLeft size={16} style={{ color: PURPLE_HI }} />
        </button>
        <ObsidianChip accentRgb="255,107,157">
          <IconHeartDuo size={14} />
          <span className="font-pixel" style={{ fontSize: 8, letterSpacing: 1.5, ...purpleText }}>US</span>
        </ObsidianChip>
      </div>
      ...
      {anniversary && (
        <div className="mb-4 p-5 text-center relative overflow-hidden" style={OBSIDIAN_FACE}>
          ...
          <div className="absolute inset-0 opacity-[0.06] pointer-events-none"
            style={{ backgroundImage: `radial-gradient(circle, ${PURPLE} 1px, transparent 1px)`, backgroundSize: '24px 24px' }} />

          <div className="relative">
            <div className="flex items-center justify-center gap-2 mb-2">
              <IconHeart size={10} />
              <p className="font-pixel" style={{ fontSize: 6, letterSpacing: 2.5, color: PURPLE_HI, textShadow: `0 0 3px ${PURPLE}66` }}>TOGETHER FOR</p>
              <IconHeart size={10} />
            </div>
            <p className="font-pixel" style={{ fontSize: 36, lineHeight: 1, ...purpleText, marginBottom: 4 }}>{anniversary.days}</p>
            <p className="font-pixel mb-3" style={{ fontSize: 8, letterSpacing: 3, color: PURPLE_LO }}>DAYS</p>
            {anniversary.milestone && (
              <div className="inline-flex items-center gap-1.5 px-3 py-1.5 mb-2 relative" style={OBSIDIAN_BTN}>
                <Rivets inset={2} />
                <IconStar size={12} />
                <span className="font-pixel" style={{ fontSize: 7, letterSpacing: 1.5, ...purpleText }}>{anniversary.milestone}</span>
              </div>
            )}
      ...
      {loveMeter && partner && (
        <div className="mb-4 p-4 relative overflow-hidden" style={OBSIDIAN_FACE}>
          ...
          <div className="absolute inset-0 opacity-[0.04] pointer-events-none"
            style={{ backgroundImage: `repeating-linear-gradient(45deg, ${PURPLE} 0, ${PURPLE} 2px, transparent 2px, transparent 8px)` }} />

          <div className="relative">
            <div className="flex items-center justify-between mb-3">
              <ObsidianChip accentRgb="245,200,66">
                <IconSwords size={14} />
                <span className="font-pixel" style={{ fontSize: 8, letterSpacing: 1.5, ...purpleText }}>CARE BATTLE</span>
              </ObsidianChip>
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="flex-1 text-center">
                <p className="font-pixel mb-1" style={{ fontSize: 7, letterSpacing: 1.5, color: PURPLE_HI, opacity: 0.85 }}>
              ...
              <div className="flex items-center justify-center relative" style={{
                ...
                <span className="font-pixel" style={{ fontSize: 9, ...purpleText }}>VS</span>
              </div>
            ...
            <div className="flex h-3 overflow-hidden" style={{
              ...
              <div style={{
                ...
                background: `linear-gradient(90deg, #FF6B9D 0%, ${PURPLE} 100%)`,
      ...
      <div className="mb-4">
        <div className="flex items-center gap-2 mb-3">
          <ObsidianChip accentRgb="167,139,250">
            ...
            <span className="font-pixel" style={{ fontSize: 8, letterSpacing: 1.5, ...purpleText }}>EREN&apos;S JOURNAL</span>
          </ObsidianChip>
        </div>
        ...
        <div className="flex gap-2 mb-3">
          ...
          <button onClick={() => { playSound('ui_tap'); handleSend() }} disabled={!msg.trim() || sending}
            ...
            <Rivets inset={2} />
            <Send size={16} style={{ color: PURPLE_HI, filter: `drop-shadow(0 0 3px ${PURPLE}aa)` }} />
          </button>
        </div>
            ...
            return (
              <div key={m.id} className="flex gap-2"
                ...
                <div className="max-w-[75%] px-3 py-2 relative" style={{
                  ...
                  borderColor: isMe ? `${PURPLE}77` : '#C4B5FD55',
