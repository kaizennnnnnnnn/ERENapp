...
const FOOD_ORDER: FoodKey[] = ['kibble', 'fish', 'treat', 'tuna', 'steak', 'cream', 'biscuit', 'shrimp', 'salmon', 'chicken', 'sausage', 'milk', 'cheese', 'yogurt', 'cake', 'sushi', 'sardine', 'egg', 'monster', 'donut', 'cookie', 'jelly_caka']
