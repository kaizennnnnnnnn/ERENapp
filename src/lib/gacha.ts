import type { GachaItemDef, GachaBannerDef, GachaRarity, GachaCategory } from '@/types'
...
export const GACHA_ITEMS: GachaItemDef[] = [
  // ── OUTFITS (Eren wears these) ─────────────────────────────────
  // Common
  { id: 'outfit_red_bowtie',     name: 'Red Bowtie',        category: 'outfit', rarity: 'common',    icon: '🎀', description: 'A classic red bowtie for a dapper cat.' },
  { id: 'outfit_blue_scarf',     name: 'Blue Scarf',        category: 'outfit', rarity: 'common',    icon: '🧣', description: 'A cozy blue scarf.' },
  { id: 'outfit_green_bandana',  name: 'Green Bandana',     category: 'outfit', rarity: 'common',    icon: '🟩', description: 'A leafy green bandana.' },
  { id: 'outfit_pink_collar',    name: 'Pink Collar',       category: 'outfit', rarity: 'common',    icon: '💗', description: 'A cute pink collar with a bell.' },
  { id: 'outfit_yellow_ribbon',  name: 'Yellow Ribbon',     category: 'outfit', rarity: 'common',    icon: '🎗️', description: 'A bright yellow ribbon on the ear.' },
  // Rare
  { id: 'outfit_pirate_hat',     name: 'Pirate Hat',        category: 'outfit', rarity: 'rare',      icon: '🏴‍☠️', description: 'Ahoy! Captain Eren reporting.' },
  { id: 'outfit_chef_hat',       name: 'Chef Hat',          category: 'outfit', rarity: 'rare',      icon: '👨‍🍳', description: 'Master chef Eren, at your service.' },
  { id: 'outfit_sunglasses',     name: 'Cool Shades',       category: 'outfit', rarity: 'rare',      icon: '😎', description: 'Too cool for school.' },
  { id: 'outfit_flower_crown',   name: 'Flower Crown',      category: 'outfit', rarity: 'rare',      icon: '🌸', description: 'A delicate crown of spring flowers.' },
  { id: 'outfit_detective_hat',  name: 'Detective Hat',     category: 'outfit', rarity: 'rare',      icon: '🕵️', description: 'Elementary, my dear hooman.' },
  // Epic
  { id: 'outfit_wizard_hat',     name: 'Wizard Hat',        category: 'outfit', rarity: 'epic',      icon: '🧙', description: 'A mystical purple wizard hat with stars.' },
  { id: 'outfit_crown',          name: 'Royal Crown',       category: 'outfit', rarity: 'epic',      icon: '👑', description: 'For the king of the household.' },
  { id: 'outfit_astronaut',      name: 'Space Helmet',      category: 'outfit', rarity: 'epic',      icon: '🚀', description: 'One small step for cat, one giant leap for catkind.' },
  // Legendary
  { id: 'outfit_angel_wings',    name: 'Angel Wings',       category: 'outfit', rarity: 'legendary', icon: '😇', description: 'Heavenly wings that shimmer with light.' },
  { id: 'outfit_dragon',         name: 'Dragon Costume',    category: 'outfit', rarity: 'legendary', icon: '🐉', description: 'Eren transforms into a fierce (cute) dragon.' },

  // ── DECORATIONS (room items) ───────────────────────────────────
  // Common
  { id: 'deco_potted_plant',     name: 'Potted Plant',      category: 'decoration', rarity: 'common',    icon: '🪴', description: 'A simple green friend.' },
  { id: 'deco_small_rug',        name: 'Small Rug',         category: 'decoration', rarity: 'common',    icon: '🟫', description: 'A cozy little rug.' },
  { id: 'deco_wall_clock',       name: 'Wall Clock',        category: 'decoration', rarity: 'common',    icon: '🕐', description: 'Tick tock, time for treats!' },
  { id: 'deco_candle',           name: 'Candle',            category: 'decoration', rarity: 'common',    icon: '🕯️', description: 'Soft flickering light.' },
  { id: 'deco_book_stack',       name: 'Book Stack',        category: 'decoration', rarity: 'common',    icon: '📚', description: 'A pile of well-loved books.' },
  // Rare
  { id: 'deco_cat_tree',         name: 'Cat Tree',          category: 'decoration', rarity: 'rare',      icon: '🌳', description: 'Multi-level climbing paradise.' },
  { id: 'deco_fish_tank',        name: 'Fish Tank',         category: 'decoration', rarity: 'rare',      icon: '🐟', description: 'Eren\'s personal TV channel.' },
  { id: 'deco_fairy_lights',     name: 'Fairy Lights',      category: 'decoration', rarity: 'rare',      icon: '✨', description: 'Twinkling string lights.' },
  { id: 'deco_vinyl_player',     name: 'Vinyl Player',      category: 'decoration', rarity: 'rare',      icon: '🎵', description: 'Lo-fi beats for study and naps.' },
  // Epic
  { id: 'deco_crystal_ball',     name: 'Crystal Ball',      category: 'decoration', rarity: 'epic',      icon: '🔮', description: 'A glowing mystic orb.' },
  { id: 'deco_neon_sign',        name: 'Neon Eren Sign',    category: 'decoration', rarity: 'epic',      icon: '💜', description: '"EREN" in glowing purple neon.' },
  { id: 'deco_fountain',         name: 'Cat Fountain',      category: 'decoration', rarity: 'epic',      icon: '⛲', description: 'A luxurious water fountain.' },
  // Legendary
  { id: 'deco_pixel_arcade',     name: 'Pixel Arcade Machine', category: 'decoration', rarity: 'legendary', icon: '🕹️', description: 'A retro arcade cabinet with cat games.' },
  { id: 'deco_enchanted_tree',   name: 'Enchanted Tree',    category: 'decoration', rarity: 'legendary', icon: '🌲', description: 'A magical glowing tree with floating leaves.' },
...
export function getCategoryLabel(cat: GachaCategory): string {
  return { outfit: 'Outfits', decoration: 'Decorations', background: 'Backgrounds', recipe: 'Recipes', emote: 'Emotes', frame: 'Frames' }[cat]
}

export const CATEGORY_ICONS: Record<GachaCategory, string> = {
  outfit: '👔', decoration: '🪴', background: '🖼️', recipe: '🍳', emote: '💫', frame: '🖼️',
}
