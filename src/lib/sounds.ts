...
export const SOUNDS = {
  ...
  jl_cream:        '/sounds/games/jelly/jl_cream.mp3',
  jl_chain:        '/sounds/games/jelly/jl_chain.mp3',
  jl_crack:        '/sounds/games/jelly/jl_crack.mp3',
  jl_tip:          '/sounds/games/jelly/jl_tip.mp3',
  jl_rack:         '/sounds/games/jelly/jl_rack.mp3',
  jl_sugar:        '/sounds/games/jelly/jl_sugar.mp3',
...
const FALLBACK: Partial<Record<SoundName, SoundName>> = {
  ...
  jl_cream:           'level_up' as SoundName,
  jl_chain:           'gacha_reveal_epic' as SoundName,
  jl_crack:           'gift_open' as SoundName,
  jl_tip:             'ui_tap' as SoundName,
  jl_rack:            'level_up' as SoundName,
  jl_sugar:           'ui_tap' as SoundName,
