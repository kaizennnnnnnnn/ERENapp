...
export type GameType = 'catch_mouse' | 'yarn_chase' | 'paw_tap' | 'memory_match' | 'treat_tumble' | 'flappy_eren' | 'tic_tac_toe' | 'eren_stack' | 'yarn_pop' | 'eren_says' | 'pawket_pinball' | 'lane_runner'
