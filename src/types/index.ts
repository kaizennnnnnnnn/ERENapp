...
export type GameType = 'catch_mouse' | 'paw_tap' | 'memory_match' | 'treat_tumble' | 'flappy_eren' | 'tic_tac_toe' | 'eren_stack' | 'yarn_pop' | 'eren_says' | 'lane_runner' | 'paw_doku' | 'yarn_sort' | 'gone_fishin'
