...
const SKINS = [
  ...
  { id: 'banana',          file: 'ErenBanana.png',          rarity: 'rare',      name: 'Banana Eren',           set: 'food' },
  ...
  { id: 'watermelon',      file: 'ErenWatermeloon.png',     rarity: 'epic',      name: 'Watermelon Eren',       set: 'food', eyesOverride: { lx: 39.5, rx: 53.8, cy: 29.6 } },
